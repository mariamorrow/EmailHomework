...
class MenuTVC: UITableViewController, EditEmailsDelegate {
...
*/
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        destVC.delegate = self.cell_delegate
        ...
        case "Sent":
            destVC.navigationItem.rightBarButtonItem = UIBarButtonItem(barButtonSystemItem: .add, target: self, action: Selector(("addEmail:")))
        default:
            destVC.navigationItem.rightBarButtonItem = nil
        }
